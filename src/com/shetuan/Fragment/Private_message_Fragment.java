...
import com.shetuan.Drawer.IndexFragment;
...
public class Private_message_Fragment extends Fragment {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			return Private_message_Container.newInstance(position);
		}
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.private_message).toUpperCase(l);
			case 1:
				return getString(R.string.private_friends).toUpperCase(l);
			}
			return null;
		}
